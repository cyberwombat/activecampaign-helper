...
(function (acs, $) {
  ...
  acs.storeEmail = function (email, cb = function () {}) { // eslint-disable-line no-unused-vars
    $.ajax({
  ...
  acs.setTracking = function (flag, cb = function () {}) { // eslint-disable-line no-unused-vars
    $.ajax({
      url: ach_params.ajax_url,
      type: 'post',
      data: {
  ...
  // Send event
  acs.sendEvent = function (name, value, email, cb = function () {}) { // eslint-disable-line no-unused-vars
    $.ajax({
      url: ach_params.ajax_url,
      type: 'post',
      data: {
